...
class Window(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.match_table.setColumnWidth(1, 100)
        self.match_table.setColumnWidth(2, 100)
        ...
        for i, match in enumerate(self.matches):
            ...
            self.match_table.setItem(i, 0, QtWidgets.QTableWidgetItem(match.short_id))
            self.match_table.setItem(i, 1, QtWidgets.QTableWidgetItem(match.date))
            self.match_table.setItem(i, 2, QtWidgets.QTableWidgetItem(match.time))
            self.match_table.setItem(i, 3, QtWidgets.QTableWidgetItem(str(match.league)))
            self.match_table.setItem(i, 4, QtWidgets.QTableWidgetItem(str(match.home_team)))
            self.match_table.setItem(i, 5, QtWidgets.QTableWidgetItem(str(match.away_team)))
